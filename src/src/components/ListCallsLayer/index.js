...
export default function ListCallsLayer({ changePoupupState, changePoupupComponent }) {
    ...
    const handleAddButtonClick = () => {
        ...
        changePoupupComponent(<CallForm changePoupupState={changePoupupState} hidePoupup={hidePoupup} changePoupupComponent={changePoupupComponent} />);
    };
    ...
    return (
        <div className="list-container">
            ...
            <div className="btn-add-call" onClick={handleAddButtonClick}>
                <img src={plusIcon} alt="Adicionar chamado" />
            </div>
        </div>
    );
}